...
The NCC_3D_ALPHA program is an easy-to-understand program that even undergraduate students can understand using only the Python language.
The NCC_3D_ALPHA program was created to provide hints and easy access methods to those who want to make their own programs such as 3D slice programs.
...
I am currently working on another project, so the support of NCC_3D_ALPHA ends here.
